            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="{{ request()->is('admin/clinic_dates') ? 'nav-link active text-sm font-semibold' : 'nav-link text-sm font-semibold'}}" href="{{ route('clinic_dates.index') }}">{{ __('Clinic Date') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="{{ request()->is('admin/clinic_visits') ? 'nav-link active text-sm font-semibold' : 'nav-link text-sm font-semibold'}}" href="{{ route('clinic_visits.index') }}">{{ __('Clinic Visit') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="{{ request()->is('admin/emergencies') ? 'nav-link active text-sm font-semibold' : 'nav-link text-sm font-semibold'}}" href="{{ route('emergencies.index') }}">{{ __('In Case of Emergency') }}</a>
                        </li>
                        @endif
